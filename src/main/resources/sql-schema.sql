...
create table if not exists ims.orders(order_id int primary key auto_increment, customer_id int NOT NULL , order_date date, order_time time, foreign key(customer_id) references customers(customer_id));
